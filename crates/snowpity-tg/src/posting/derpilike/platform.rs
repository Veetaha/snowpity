...
// mod derpibooru {
//     type Platform = super::Platform<DerpibooruImp>;

//     struct DerpibooruImp;

//     impl Derpilike for DerpibooruImp {}
// }
...
// #[async_trait]
// impl<Imp: Derpilike> PlatformTrait for Platform<Imp> {
//     type Config = Config;

//     const NAME: &'static str = Imp::DISPLAY_NAME;

//     fn new(params: PlatformParams<Config>) -> Self {
//         Self {
//             api: api::Client::new(params.config, params.http),
//             // api: api::Client::new(params.config, params.http, Imp::),
//             db: db::BlobCacheRepo::new(params.db),
//         }
//     }

//     fn parse_query(query: &str) -> ParseQueryResult<MediaId> {
//         Imp::parse_query(query)
//     }
